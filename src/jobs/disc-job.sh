...
#
#  RMSprop optimizer:
#     rmsprop_lr0.01_batch_size1
#     rmsprop_lr0.01_batch_size1_use_glove
...
#     sgd_lr0.5_batch_size1
#     sgd_lr0.5_batch_size1_use_glove
#
#  SGD optimizer with momentum:
#     sgd_lr0.1_batch_size1_momentum0.9
#     sgd_lr0.1_batch_size1_momentum0.9_use_glove
#     sgd_lr0.5_batch_size1_momentum0.9
#     sgd_lr0.5_batch_size1_momentum0.9_use_glove
#
...
LR=0.1
MOMENTUM=0.9
NAME=${OPTIM}_lr${LR}_batch_size1_momentum${MOMENTUM}  # name of experiment
mkdir -p $OUTDIR/$NAME
python $SRCDIR/main.py train disc \
    --data $TMP/data \
    --disable-subdir \
...
LR=0.1
MOMENTUM=0.9
NAME=${OPTIM}_lr${LR}_batch_size1_momentum${MOMENTUM}_use_glove  # name of experiment
mkdir -p $OUTDIR/$NAME
python $SRCDIR/main.py train disc \
    --data $TMP/data \
    --disable-subdir \
