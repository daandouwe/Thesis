...
# ============================================================================== #
# This script is an edit of `disc-job.sh`. The following changes were made.
#   1. Dropout is disabled (possible cause for NaN)
#   2. Smaller learning rates (some rates were totally hopeless as shown in the
#       results from `disc-job.sh`.)
#   3. No momentum: all experiments with momentum gave terrible results.
#
...
#     adam_lr0.0005_batch_size1
#     adam_lr0.0005_batch_size1_use_glove
#     adam_lr0.0001_batch_size1
#     adam_lr0.0001_batch_size1_use_glove
#
#  RMSprop optimizer:
#     rmsprop_lr0.001_batch_size1
#     rmsprop_lr0.001_batch_size1_use_glove
#
#  SGD optimizer:
#     sgd_lr0.1_batch_size1
#     sgd_lr0.1_batch_size1_use_glove
#     sgd_lr0.05_batch_size1
#     sgd_lr0.05_batch_size1_use_glove
#     sgd_lr0.01_batch_size1
#     sgd_lr0.01_batch_size1_use_glove
#     sgd_lr0.005_batch_size1
#     sgd_lr0.005_batch_size1_use_glove
#
#
...
OPTIM=adam
LR=0.001
NAME=${OPTIM}_lr${LR}_batch_size1  # name of experiment
mkdir -p $OUTDIR/$NAME
...
OPTIM=adam
LR=0.001
NAME=${OPTIM}_lr${LR}_batch_size1_use_glove  # name of experiment
mkdir -p $OUTDIR/$NAME
python $SRCDIR/main.py train disc \
    --data $TMP/data \
    --disable-subdir \
