...
class SpanMultitaskLanguageModel(object):
    def __init__(
            self,
            model,
            word_vocab,
...
class SupertagMultitaskLanguageModel(object):
    def __init__(
            self,
            model,
            word_vocab,
        ...
        self.model = model.add_subcollection("SupertagMultitaskLanguageModel")
        self.word_vocab = word_vocab
        self.label_vocab = label_vocab
        self.lstm_dim = lstm_dim
        ...
        self.f_label = Feedforward(
            self.model, lstm_dim, [label_hidden_dim], label_vocab.size)
