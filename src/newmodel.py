...
from newdata import PAD_INDEX, EMPTY_INDEX, REDUCED_INDEX, REDUCED_TOKEN, wrap, load_glove
...
class RNNG(nn.Module):
    ...
    def __init__(self, dictionary, emb_dim, emb_dropout,
        ...
        mlp_input = 3 * lstm_hidden # buffer and history are bidirectional, StackLSTM is unidirectional
    ...
    def encode(self, stack, buffer, history):
        ...
        h = self.history_lstm(history) # Returns new hidden state.
        s = self.stack_lstm(stack) # Returns new hidden state.
