...
\node(EMPTY) at ($(ADJP)+(1,3)$){$\varnothing_{1}^{4}$} ;
\node(NP) at ($(ADJP)+(3,3)$){$\text{NP}_{1}^{4}$} ;

\node(NP2) at ($(A)+(3,8)$){$\text{NP}_{0}^{4}$} ;

% \node(EMPTY2) at ($(b)+(1.5,11)$){$\varnothing_{0}^{5}$} ;
\node(EMPTY2) at ($(E)+(0.5,5)$){$\varnothing_{4}^{6}$} ;
...
\draw[->] (A) to ++(-0.1,3) to [in=-90,out=90](NP2) ;
...
\draw[->] (F) to [in=-90,out=90](EMPTY2);

\draw[->] (EMPTY2) to [in=-90,out=90](S);
% \draw[->] (F) to [in=-90,out=90](S);
\draw[->] (NP2) to [in=-90,out=90](S);
