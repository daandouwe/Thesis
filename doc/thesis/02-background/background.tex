...
\begin{definition}{(C-command)} \textit{C-command}, or \textit{Constituent command} is the property that....
  \begin{itemize}
    \item
    \item
  \end{itemize}
