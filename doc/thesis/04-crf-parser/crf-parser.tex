...
\section{Problems as proposal}
  ...
  \subsection{Consequences}
    The direct consequence of the derrivational ambiguity is that our CRF actually defines a distribution over $\mathcal{D}(x)$, and over $\yieldx$ only through by summing over the derrivations that collapse to it. Let $\y$ be a general tree. Then our CRF assigns probabilities to all $d \in f^{-1}(y)$ and defines a distribution over $\yieldx$ as
    \begin{align*}
